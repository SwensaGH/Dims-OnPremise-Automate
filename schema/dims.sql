...
INSERT INTO `project_settings` VALUES (1,'dashboard_usage','0',NULL,NULL,NULL), (2,'dashboard_monthly_notification','0',NULL,NULL,NULL), (3,'dashboard_average_age','0',NULL,NULL,NULL),(4,'Customer','pisd',NULL,NULL,NULL) (5,'logo_light','lisd_light.png',NULL,NULL,NULL), (6,'logo_dark','lisd_dark.png',NULL,NULL,NULL), (7,'dashboard_daily_notification','0',NULL,NULL,NULL), (8,'Authentication','local','{ "url": "", "domain": "", "grantedAuthorities": { "admin": [], "observer": [] } }',NULL,NULL), (9,'SSL','1','',NULL,NULL);
