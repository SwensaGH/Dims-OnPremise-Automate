...
echo curl -X POST "http://$ip/auth/register" -H 'accept: */*' -H 'Content-Type: application/json'  -d '{ "userid": "0", "email": "$email", "password" : "$password", "firstname": "Dims", "lastname": "Admin",  "phoneNumber": "1231231234", "roleId": [ 1 ], "groupId": [] }'
