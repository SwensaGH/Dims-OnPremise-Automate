...
echo
echo curl -X 'POST' 'http://'"$ip"'/auth/register' -H 'accept: */*' -H 'Content-Type: application/json' -d '{"userid": 0, "active":true, "email": "'"$email"'", "password": "'"$password"'", "firstname": "I3", "lastname": "App", "phoneNumber": "123-123-1234", "roleId": [1], "groupId": [] }'
